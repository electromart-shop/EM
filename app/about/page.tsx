    ...
    <div className="bg-gray-50 min-h-screen py-16 lg:py-24">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-brand-orange text-white rounded-2xl mb-6 shadow-lg shadow-brand-orange/30">
          ...
          <div className="p-8 md:p-12 lg:p-16 relative z-10">
            <div className="prose prose-lg md:prose-xl text-gray-600 max-w-none">
              <p className="font-medium text-gray-900 text-2xl leading-relaxed mb-8">
                ELECTROMART was started by engineering students who faced a common problem — electronic components were overpriced and not easily accessible for students.
              </p>
              
              <p className="mb-6">
                While working on projects, we realized many students couldn't build their ideas due to high hardware costs. The gap between an innovative concept and a working prototype was often just the price of components.
              </p>
              ...
              <div className="my-10 p-8 bg-gray-50 rounded-2xl border-l-4 border-brand-orange">
                <p className="text-xl font-medium text-gray-800 m-0 italic">
                  "So we created ELECTROMART to provide electronics components at near wholesale prices across Tamil Nadu."
                </p>
              </div>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white border border-gray-200 p-10 rounded-3xl relative overflow-hidden group hover:border-brand-orange/30 hover:shadow-lg transition-all duration-300">
            ...
            <p className="text-gray-600 leading-relaxed text-lg">
              To become the backbone of student innovation across India, creating an ecosystem where every hardware idea can be brought to life quickly and affordably.
            </p>
          </div>
        </div>
